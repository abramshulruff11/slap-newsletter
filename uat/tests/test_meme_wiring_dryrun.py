...
STORY_PLAN = {
  ...
  "supporting_stories":[
    {"topic":"deadline","headline":"Swerve","tweets":[],"research_notes":"n",
     "gif_concept":"","meme_concept":"last second","meme_template":"left-exit-12-off-ramp",
     "meme_subject":"A front office","beats":[]},
...
assert rendered == ["distracted-boyfriend","left-exit-12-off-ramp"], rendered
